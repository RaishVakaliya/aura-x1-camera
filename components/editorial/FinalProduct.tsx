    ...
    const ctx = gsap.context(() => {
      ...
      if (link) {
        link.addEventListener('mouseenter', () =>
          gsap.to(link, { opacity: 0.6, x: 4, duration: 0.25, ease: 'power2.out' })
        );
      ...
      >
        ...
        >
          <div>
            ...
            >
              Designed around the moment before the shutter opens. Every surface,
              dial, and optical element exists to bring the photographer closer
              to the image.
            </p>
          ...
          >
            <Image
              src="/editorial/final_showcase.png"
